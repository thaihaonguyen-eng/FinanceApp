...
const styles = StyleSheet.create({
  ...
  profileCard: { flexDirection: 'row', alignItems: 'center', margin: 25, padding: 30, backgroundColor: '#FFF', borderRadius: 40, elevation: 10 }, avatarContainer: { position: 'relative' }, avatar: { width: 80, height: 80, borderRadius: 40, justifyContent: 'center', alignItems: 'center' }, badge: { position: 'absolute', bottom: 0, right: 0, backgroundColor: '#1E293B', width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FFF' },
  group: { backgroundColor: '#FFF', marginHorizontal: 25, borderRadius: 35, padding: 15, elevation: 6 }, row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20 }, iconBox: { width: 32, height: 32, borderRadius: 12, justifyContent: 'center', alignItems: 'center', backgroundColor: '#ECFDF5' }, rowText: { fontSize: 17, fontWeight: '800', color: '#1E293B', marginLeft: 15 },
  ...
  logoutBtn: { flexDirection: 'row', margin: 25, backgroundColor: '#EF4444', padding: 24, borderRadius: 30, alignItems: 'center', justifyContent: 'center', elevation: 10 }
});
