...
const styles = StyleSheet.create({
  ...
  walletCard: { width: 190, minHeight: 140, padding: 25, borderRadius: 32, marginRight: 15, shadowColor: '#000', shadowOpacity: 0.1, shadowOffset: { width: 0, height: 6 }, shadowRadius: 15, elevation: 6 }, walletName: { color: '#FFF', fontSize: 15, opacity: 0.9, fontWeight: '600' }, walletBalance: { color: '#FFF', fontSize: 20, fontWeight: '900', marginTop: 8 },
